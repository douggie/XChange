...
public class OkexMarketDataService extends OkexMarketDataServiceRaw implements MarketDataService {
  ...
  public OkexMarketDataService(OkexExchangeV5 exchange) {
    super(exchange);
  }
  ...
  public Ticker getTicker(CurrencyPair currencyPair, Object... args) throws IOException {
    OkexSpotTicker tokenPairInformation =
        okex.getSpotTicker(OkexAdaptersV5.toSpotInstrument(currencyPair));
    return OkexAdaptersV5.convert(tokenPairInformation);
  }
  ...
  public OrderBook getOrderBook(CurrencyPair pair, Object... args) throws IOException {
    ...
    OkexOrderBook okexOrderbook =
        okex.getOrderBook(OkexAdaptersV5.toSpotInstrument(pair), limitDepth);
    return OkexAdaptersV5.convertOrderBook(okexOrderbook, pair);
  }
}
