...
public interface OkexV5 {
  ...
  @GET
  @Path("/account/v5/withdrawal/history")
  ...
  @GET
  @Path("/account/v5/deposit/history")
  ...
  @POST
  @Path("/spot/v5/cancel_orders/{order_id}")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @POST
  @Path("/spot/v5/cancel_batch_orders")
  @Consumes(MediaType.APPLICATION_JSON)
  /**
   * @param req
  ...
  @GET
  @Path("/spot/v5/instruments")
  List<Instrument> getAllSpotInstruments() throws IOException, OkexException;

  @GET
  @Path("/spot/v5/instruments/ticker")
  List<OkexSpotTicker> getAllSpotTickers() throws IOException, OkexException;

  @GET
  @Path("/spot/v5/instruments/{instrument_id}/ticker")
  OkexSpotTicker getSpotTicker(@PathParam("instrument_id") String instrumentId)
      throws IOException, OkexException;

  @GET
  @Path("/spot/v5/instruments/{instrument_id}/book")
  ...
  List<Instrument> getAllFutureInstruments() throws IOException, OkexException;

  @GET
  @Path("/futures/v5/instruments/ticker")
  List<OkexFutureTicker> getAllFutureTickers() throws IOException, OkexException;

  @GET
  @Path("/futures/v5/position")
  ...
  @GET
  @Path("/futures/v5/accounts/{currency}")
  ...
  @GET
  @Path("/futures/v5/accounts/{currency}/leverage")
   ...
   */
  @GET
  @Path("/futures/v5/accounts/{underlying}/ledger")
   ...
   */
  @GET
  @Path("/futures/v5/orders/{instrument_id}")
  ...
  @POST
  @Path("/futures/v5/cancel_order/{instrument_id}/{order_id}")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @POST
  @Path("/futures/v5/cancel_batch_orders/{instrument_id}")
  @Consumes(MediaType.APPLICATION_JSON)
   ...
   */
  @GET
  @Path("/swap/v5/instruments")
  List<Instrument> getAllSwapInstruments() throws IOException, OkexException;

  @GET
  @Path("/swap/v5/instruments/ticker")
   ...
   */
  @GET
  @Path("/swap/v5/orders/{instrument_id}")
  ...
  @POST
  @Path("/swap/v5/cancel_order/{instrument_id}/{order_id}")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @POST
  @Path("/swap/v5/cancel_batch_orders/{instrument_id}")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @GET
  @Path("/margin/v5/accounts/availability")
  ...
  @POST
  @Path("/margin/v5/accounts/{instrument_id}/leverage")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @POST
  @Path("/margin/v5/accounts/borrow")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @POST
  @Path("/margin/v5/accounts/repayment")
  @Consumes(MediaType.APPLICATION_JSON)
  ...
  @POST
  @Path("/margin/v5/cancel_order/{instrument_id}/{order_id}")
  @Consumes(MediaType.APPLICATION_JSON)
